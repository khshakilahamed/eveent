          ...
          <>
            <li>
              <Link to="/userSpecification">
                <button className="btn btn-success">Getting Started</button>
              </Link>
            </li>
          </>
        )
        ...
        <>
          ...
          <div className="dropdown dropdown-end">
                ...
                <img
                  src={`${
                    user?.photoURL
                      ...
                      : userInfo?.photoURL
                      ? userInfo.photoURL
                      : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdagfNlkCXKS54rDkgY6CjGNtPECsI_SZlKQ&usqp=CAU"
                  }`}
                  alt="user icon"
                />
            ...
            >
              ...
              <li className="my-1">
                <Link to="/dashboard/myProfile" className="hover:bg-none">
                  Profile
                </Link>
              </li>
              <li>
