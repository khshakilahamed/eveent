...
const ManageHalls = () => {
    ...
    const searchHotels = () => {
        ...
        transformHotels = transformHotels.filter(hotel => hotel.email.toLowerCase().includes(searchingValue.toLowerCase()));
                    ...
                    <tbody>
                        {
                            searchHotels().length > 0 && (
                                searchHotels().slice(page * numberOfElementPerPage - numberOfElementPerPage, page * numberOfElementPerPage)?.map(hotel => <tr key={hotel?._id}>
                                    <td>
